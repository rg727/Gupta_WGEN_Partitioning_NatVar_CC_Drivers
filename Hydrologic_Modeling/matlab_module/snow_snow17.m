function [snow_outflow, snow_melt, snow_swe, new_IniState] = snow_snow17(S_date, E_date, Prcp, Tavg, Elev, Par, IniState)
%#codegen
...
%     end
    ...
    if Melt < W_i
        ...
        elseif (Qw + W_q) >= Deficit %& ((Qw + W_q) <= ((Deficit*(1+PLWHC)) + W_qx))

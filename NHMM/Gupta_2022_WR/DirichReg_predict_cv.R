...
DirichReg_predict_cv <- function(param,WR.PCs,num.states,WR_frac,WR_frac.DR,yr,yr_recon,spi_recon.pcs,smooth.list,use.smooth,leave.k.out) {
  ...
  out <- list(WR.pred.cv,MSE,log.lik)
  return(out)
